...
class AMPTrainer(SimpleTrainer):
    ...
    def run_step(self, cfg):
        ...
        if cfg.DATASETS.NAMES[0].lower() in data['img_paths'][0].lower():
            data_name = 'Expert1'
        elif cfg.DATASETS.NAMES[1].lower() in data['img_paths'][0].lower():
            data_name = 'Expert2'
        elif cfg.DATASETS.NAMES[2].lower() in data['img_paths'][0].lower():
            data_name = 'Expert3'

        if data_name == 'Expert1':
            self.set_bn_expert_train(self.model.heads_expert1)
            self.set_bn_expert_eval(self.model.heads_expert2)
            self.set_bn_expert_eval(self.model.heads_expert3)
        elif data_name == 'Expert2':
            self.set_bn_expert_eval(self.model.heads_expert1)
            self.set_bn_expert_train(self.model.heads_expert2)
            self.set_bn_expert_eval(self.model.heads_expert3)
        elif data_name == 'Expert3':
            self.set_bn_expert_eval(self.model.heads_expert1)
            self.set_bn_expert_eval(self.model.heads_expert2)
            self.set_bn_expert_train(self.model.heads_expert3)
    ...
    def set_bn_expert_eval(self, heads):
    ...
    def set_bn_expert_train(self, heads):
        for name, module in heads.named_children():
            if "bottleneck" in name:
                for name, module in module.named_children():
                    module.train()
