...
class ResNet(nn.Module):
    def __init__(self, last_stride, bn_norm, with_ibn, with_se, with_nl, with_in, block, layers, non_layers):
        self.inplanes = 64
        super().__init__()
...
def build_resnet_backbone(cfg):
    ...
    model = ResNet(last_stride, bn_norm, with_ibn, with_se, with_nl, with_in, block,
